...
# ── PRODUCTOS ─────────────────────────────────────────────────────────────────
CATALOG_VERSION = "2026-04-24-v6-recetario"  # Bump this to force re-sync of product catalog
...
_HARDCODED_PRODUCTS = [
    ...
    ("Pastelería", "barritas proteicas", "u", "Mostrador"),
    ("Pastelería", "Bola danesa", "u", "Mostrador"),
    ("Pastelería", "Brownie de chocolate", "u", "Mostrador"),
    ("Pastelería", "Brownie de dulce de leche", "u", "Mostrador"),
    ("Pastelería", "Cereal cookies", "u", "Mostrador"),
    ("Pastelería", "datiles con chocolate", "u", "Mostrador"),
    ("Pastelería", "muffins de banana", "u", "Mostrador"),
    ...
    ("Aceites", "Aceite de girasol", "lt", "Cocina"),
    ("Aceites", "Aceite de oliva", "kg", "Cocina"),
    ("Aceites", "Aceite de trufa", "kg", "Cocina"),
    ("Aceites", "Alcohol", "lt", "Cocina"),
    # ── Aromas ──
    ("Aromas", "Agua de azhar", "kg", "Cocina"),
    ("Aromas", "Escencia de vainilla", "lt", "Cocina"),
    ("Aromas", "Extracto de vainilla", "kg", "Cocina"),
    ("Aromas", "proteina de vainilla diabla", "kg", "Cocina"),
    ("Aromas", "royal fruit", "kg", "Cocina"),
    # ── Azucares ──
    ("Azucares", "Azucar blanca", "kg", "Cocina"),
    ("Azucares", "Azucar impalpable", "kg", "Cocina"),
    ("Azucares", "Azucar mascabo", "kg", "Cocina"),
    ("Azucares", "Azucar negra", "kg", "Cocina"),
    ("Azucares", "Azucar rubia", "kg", "Cocina"),
    ("Azucares", "copoz de maiz sin azucar", "u", "Cocina"),
    ("Azucares", "Glucosa", "kg", "Cocina"),
    ("Azucares", "Miel", "kg", "Cocina"),
    ("Azucares", "Mix azucar y canela roll", "kg", "Cocina"),
    # ── Chocolateria ──
    ("Chocolateria", "barritas de chocolate", "kg", "Cocina"),
    ("Chocolateria", "Bizcocho de chocolate", "u", "Cocina"),
    ("Chocolateria", "Cacao en polvo", "kg", "Cocina"),
    ("Chocolateria", "chocolate blanco alpino", "kg", "Cocina"),
    ("Chocolateria", "Chocolate callebaut amargo", "kg", "Cocina"),
    ("Chocolateria", "chocolate callebaut leche", "kg", "Cocina"),
    ("Chocolateria", "chocolate callebaut semi", "kg", "Cocina"),
    ("Chocolateria", "cobertura blanca callebaut", "kg", "Cocina"),
    ("Chocolateria", "cobertura datiles", "kg", "Cocina"),
    ("Chocolateria", "cookie chocolate y cafe", "kg", "Cocina"),
    ("Chocolateria", "Cookie de vainilla y chocolate elaboracion", "u", "Cocina"),
    ("Chocolateria", "Ganache de chocolate", "u", "Cocina"),
    ("Chocolateria", "glaseado de chocolate blanco", "kg", "Cocina"),
    ("Chocolateria", "Manteca de cacao", "kg", "Cocina"),
    ("Chocolateria", "Nibs de cacao", "kg", "Cocina"),
    ("Chocolateria", "salsa de chocolate", "kg", "Cocina"),
    # ── Condimentos ──
    ("Condimentos", "Agar Agar", "kg", "Cocina"),
    ("Condimentos", "Ajo en polvo", "kg", "Cocina"),
    ("Condimentos", "Anis estrellado", "kg", "Cocina"),
    ("Condimentos", "Bicarbonato de sodio", "kg", "Cocina"),
    ("Condimentos", "Canela en polvo", "kg", "Cocina"),
    ("Condimentos", "Canela en rama", "kg", "Cocina"),
    ("Condimentos", "Cardamomo", "kg", "Cocina"),
    ("Condimentos", "Cebolla en polvo", "kg", "Cocina"),
    ("Condimentos", "Clavo de olor", "kg", "Cocina"),
    ("Condimentos", "Comino en polvo", "kg", "Cocina"),
    ("Condimentos", "crema roll de canela", "kg", "Cocina"),
    ("Condimentos", "Curcuma en polvo", "kg", "Cocina"),
    ("Condimentos", "Curry en polvo", "kg", "Cocina"),
    ("Condimentos", "Garam masala en polvo", "kg", "Cocina"),
    ("Condimentos", "Goma Xantica", "kg", "Cocina"),
    ("Condimentos", "Humo liquido", "kg", "Cocina"),
    ("Condimentos", "Laurel", "kg", "Cocina"),
    ("Condimentos", "Lecitina de soja", "kg", "Cocina"),
    ("Condimentos", "Levadura", "kg", "Cocina"),
    ("Condimentos", "Masa madre", "kg", "Cocina"),
    ("Condimentos", "Mostaza", "kg", "Cocina"),
    ("Condimentos", "Oregano seco", "kg", "Cocina"),
    ("Condimentos", "Pimenton", "kg", "Cocina"),
    ("Condimentos", "Pimenton en polvo", "kg", "Cocina"),
    ("Condimentos", "Pimienta de jamaica", "kg", "Cocina"),
    ("Condimentos", "Pimienta negra", "kg", "Cocina"),
    ("Condimentos", "Polvo de hornear", "kg", "Cocina"),
    ("Condimentos", "Sal en escamas", "kg", "Cocina"),
    ("Condimentos", "Sal fina", "kg", "Cocina"),
    ("Condimentos", "Sal negra", "kg", "Cocina"),
    ("Condimentos", "Vinagre", "kg", "Cocina"),
    # ── Freezados ──
    ("Freezados", "Bavka chocolate elaboracion", "u", "Cocina"),
    ("Freezados", "Bavka pistacho elaboracion", "u", "Cocina"),
    ("Freezados", "brioche de pastelera elaboracion", "u", "Cocina"),
    ("Freezados", "Croissant almendras elaboracion", "u", "Cocina"),
    ("Freezados", "Croissant elaboracion", "u", "Cocina"),
    ("Freezados", "Masa hojaldre", "kg", "Cocina"),
    ("Freezados", "Masa laminados", "u", "Cocina"),
    ("Freezados", "Medialuna elaboracion", "u", "Cocina"),
    ("Freezados", "palito de queso elaboracion", "u", "Cocina"),
    ("Freezados", "pan de chocolate con almendras elaboracion", "u", "Cocina"),
    ("Freezados", "Pan de chocolate elaboracion", "u", "Cocina"),
    ("Freezados", "Pan suisse elaboracion", "u", "Cocina"),
    ("Freezados", "Roll de canela elaboracion", "u", "Cocina"),
    ("Freezados", "roll de frambuesa elaboracion", "u", "Cocina"),
    # ── Frutas ──
    ("Frutas", "Arandanos", "kg", "Cocina"),
    ("Frutas", "arandanos congelados", "kg", "Cocina"),
    ("Frutas", "arandanos desidratados", "kg", "Cocina"),
    ("Frutas", "Banana", "kg", "Cocina"),
    ("Frutas", "Cereza", "kg", "Cocina"),
    ("Frutas", "Ciruela", "kg", "Cocina"),
    ("Frutas", "Durazno", "kg", "Cocina"),
    ("Frutas", "Frutilla", "kg", "Cocina"),
    ("Frutas", "Frutilla congelada", "kg", "Cocina"),
    ("Frutas", "Ganache de limon invierno", "kg", "Cocina"),
    ("Frutas", "Ganache de limon verano", "kg", "Cocina"),
    ("Frutas", "gel de limon", "kg", "Cocina"),
    ("Frutas", "Higos", "u", "Cocina"),
    ("Frutas", "Jugo de limon", "lt", "Cocina"),
    ("Frutas", "Jugo de manzana verde elaboracion", "lt", "Cocina"),
    ("Frutas", "Jugo de naranja elaboracion", "lt", "Cocina"),
    ("Frutas", "Kaki", "kg", "Cocina"),
    ("Frutas", "Kiwi", "kg", "Cocina"),
    ("Frutas", "Lima", "kg", "Cocina"),
    ("Frutas", "Limon", "kg", "Cocina"),
    ("Frutas", "limonada mango y maracuya elaboracion", "kg", "Cocina"),
    ("Frutas", "limonada menta elaboracion", "kg", "Cocina"),
    ("Frutas", "Mandarina", "kg", "Cocina"),
    ("Frutas", "Mango congelado", "kg", "Cocina"),
    ("Frutas", "Manzana roja", "kg", "Cocina"),
    ("Frutas", "Manzana verde", "kg", "Cocina"),
    ("Frutas", "Maracuya", "kg", "Cocina"),
    ("Frutas", "maracuya congelada", "kg", "Cocina"),
    ("Frutas", "masa tarteleta de frutílla", "u", "Cocina"),
    ("Frutas", "Melon", "kg", "Cocina"),
    ("Frutas", "Membrillo", "kg", "Cocina"),
    ("Frutas", "Mermelada membrillo", "kg", "Cocina"),
    ("Frutas", "Naranja", "kg", "Cocina"),
    ("Frutas", "Pelon", "kg", "Cocina"),
    ("Frutas", "Pera", "kg", "Cocina"),
    ("Frutas", "Pomelo", "kg", "Cocina"),
    ("Frutas", "Pure de banana", "kg", "Cocina"),
    ("Frutas", "ralladura de limon", "kg", "Cocina"),
    ("Frutas", "salsa de frutilla", "kg", "Cocina"),
    ("Frutas", "Sandia", "kg", "Cocina"),
    ("Frutas", "Uva", "kg", "Cocina"),
    # ── Frutos secos ──
    ("Frutos secos", "Almendras fileteadas", "kg", "Cocina"),
    ("Frutos secos", "Almendras guaras", "kg", "Cocina"),
    ("Frutos secos", "Arroz yamani", "kg", "Cocina"),
    ("Frutos secos", "Arroz yamani cocido", "kg", "Cocina"),
    ("Frutos secos", "Avellanas", "kg", "Cocina"),
    ("Frutos secos", "Cookie de mani elaboracion", "u", "Cocina"),
    ("Frutos secos", "Escencia de almendras", "lt", "Cocina"),
    ("Frutos secos", "licor de almendras", "kg", "Cocina"),
    ("Frutos secos", "Mani", "kg", "Cocina"),
    ("Frutos secos", "Mix de semillas", "kg", "Cocina"),
    ("Frutos secos", "Nuez mariposa", "kg", "Cocina"),
    ("Frutos secos", "Pasta de mani king", "kg", "Cocina"),
    ("Frutos secos", "Pasta de nuez", "kg", "Cocina"),
    ("Frutos secos", "Pasta de pistacho", "kg", "Cocina"),
    ("Frutos secos", "Pasta de semillas", "kg", "Cocina"),
    ("Frutos secos", "pasta de sesamo", "kg", "Cocina"),
    ("Frutos secos", "pasta de sesamo con dulce de leche", "kg", "Cocina"),
    ("Frutos secos", "Pistachos", "kg", "Cocina"),
    ("Frutos secos", "Relleno mani", "kg", "Cocina"),
    ("Frutos secos", "semilla de sesamo", "kg", "Cocina"),
    ("Frutos secos", "semilla de sesamo elaboracion", "kg", "Cocina"),
    ("Frutos secos", "semilla de sesamo negro", "kg", "Cocina"),
    ("Frutos secos", "Semillas de amapola", "kg", "Cocina"),
    ("Frutos secos", "semillas de calabaza", "kg", "Cocina"),
    ("Frutos secos", "Semillas de chia", "kg", "Cocina"),
    ("Frutos secos", "Semillas de girasol", "kg", "Cocina"),
    ("Frutos secos", "Semillas de lino", "kg", "Cocina"),
    ("Frutos secos", "Semillas de sesamo", "kg", "Cocina"),
    ("Frutos secos", "semillas de sesamo blanco", "kg", "Cocina"),
    ("Frutos secos", "semillas de zapallo", "kg", "Cocina"),
    ("Frutos secos", "tahina", "kg", "Cocina"),
    # ── Harinas y cereales ──
    ("Harinas y cereales", "Avena en hojuelas", "kg", "Cocina"),
    ("Harinas y cereales", "Avena gruesa", "kg", "Cocina"),
    ("Harinas y cereales", "Cookie de avena", "u", "Cocina"),
    ("Harinas y cereales", "Cous cous", "kg", "Cocina"),
    ("Harinas y cereales", "Fecula de maiz", "kg", "Cocina"),
    ("Harinas y cereales", "Fecula de mandioca", "kg", "Cocina"),
    ("Harinas y cereales", "Harina 000", "kg", "Cocina"),
    ("Harinas y cereales", "Harina 0000", "kg", "Cocina"),
    ("Harinas y cereales", "Harina 5 estrellas", "kg", "Cocina"),
    ("Harinas y cereales", "Harina de almendras", "kg", "Cocina"),
    ("Harinas y cereales", "Harina de avena", "kg", "Cocina"),
    ("Harinas y cereales", "Harina de centeno", "kg", "Cocina"),
    ("Harinas y cereales", "Harina de fuerza", "kg", "Cocina"),
    ("Harinas y cereales", "Harina de garbanzos", "kg", "Cocina"),
    ("Harinas y cereales", "Harina de maiz", "kg", "Cocina"),
    ("Harinas y cereales", "Harina integral", "kg", "Cocina"),
    ("Harinas y cereales", "Harina leudante", "kg", "Cocina"),
    ("Harinas y cereales", "Leche de avena", "kg", "Cocina"),
    ("Harinas y cereales", "Maicena", "kg", "Cocina"),
    # ── Lacteos ──
    ("Lacteos", "Anchoa", "kg", "Cocina"),
    ("Lacteos", "Claras", "kg", "Cocina"),
    ("Lacteos", "Crema de leche barra", "kg", "Cocina"),
    ("Lacteos", "Crema de leche cocina", "lt", "Cocina"),
    ("Lacteos", "Dulce de leche", "kg", "Cocina"),
    ("Lacteos", "Flan de dulce de leche", "kg", "Cocina"),
    ("Lacteos", "Huevo", "kg", "Cocina"),
    ("Lacteos", "Leche de coco en lata", "kg", "Cocina"),
    ("Lacteos", "leche desc sachet", "kg", "Cocina"),
    ("Lacteos", "Leche descremada", "kg", "Cocina"),
    ("Lacteos", "Leche deslactosada", "kg", "Cocina"),
    ("Lacteos", "leche en polvo", "kg", "Cocina"),
    ("Lacteos", "Leche entera", "kg", "Cocina"),
    ("Lacteos", "leche entera sachet", "kg", "Cocina"),
    ("Lacteos", "Manteca", "kg", "Cocina"),
    ("Lacteos", "Manteca clarificada", "kg", "Cocina"),
    ("Lacteos", "Manteca saborizada", "kg", "Cocina"),
    ("Lacteos", "Muzzarella", "kg", "Cocina"),
    ("Lacteos", "Queso crema", "kg", "Cocina"),
    ("Lacteos", "Queso sando", "kg", "Cocina"),
    ("Lacteos", "Queso sardo", "kg", "Cocina"),
    ("Lacteos", "Queso tybo", "kg", "Cocina"),
    ("Lacteos", "Relleno wraps ricota", "u", "Cocina"),
    ("Lacteos", "Ricota", "kg", "Cocina"),
    ("Lacteos", "ricota elaboracion", "kg", "Cocina"),
    ("Lacteos", "Yemas", "kg", "Cocina"),
    ("Lacteos", "Yogurt", "kg", "Cocina"),
    ("Lacteos", "Yogurt Kay", "kg", "Cocina"),
    ("Lacteos", "Yogurt saborizado", "kg", "Cocina"),
    # ── Legumbres ──
    ("Legumbres", "Aceitunas", "kg", "Cocina"),
    ("Legumbres", "Alcaparras", "kg", "Cocina"),
    ("Legumbres", "arroz integral", "kg", "Cocina"),
    ("Legumbres", "Arvejas", "kg", "Cocina"),
    ("Legumbres", "Arvejas congeladas", "kg", "Cocina"),
    ("Legumbres", "Datiles", "kg", "Cocina"),
    ("Legumbres", "Garbanzos", "kg", "Cocina"),
    ("Legumbres", "Garbanzos lata", "kg", "Cocina"),
    ("Legumbres", "Lentejas", "kg", "Cocina"),
    ("Legumbres", "Lentejas turcas", "kg", "Cocina"),
    ("Legumbres", "Maiz blanco", "kg", "Cocina"),
    ("Legumbres", "Poroto alubia", "kg", "Cocina"),
    ("Legumbres", "Poroto pallares", "kg", "Cocina"),
    ("Legumbres", "Porotos mung", "kg", "Cocina"),
    ("Legumbres", "Quinoa cocida", "kg", "Cocina"),
    ("Legumbres", "Quinoa pop", "kg", "Cocina"),
    ("Legumbres", "Quinoa roja", "kg", "Cocina"),
    ("Legumbres", "Salsa de soja", "kg", "Cocina"),
    ("Legumbres", "Soja texturizada", "kg", "Cocina"),
    ("Legumbres", "Trigo burgol", "kg", "Cocina"),
    ("Legumbres", "Trigo sarraceno", "kg", "Cocina"),
    # ── Proteinas ──
    ("Proteinas", "Atun lata", "kg", "Cocina"),
    ("Proteinas", "Mezcla atun sandwich", "kg", "Cocina"),
    ("Proteinas", "mezcla trucha melt", "kg", "Cocina"),
    ("Proteinas", "Trucha ahumada", "kg", "Cocina"),
    ("Proteinas", "Trucha salmonada freco", "kg", "Cocina"),
    # ── Salsas ──
    ("Salsas", "Gochujang", "kg", "Cocina"),
    ("Salsas", "Mayonesa", "kg", "Cocina"),
    ("Salsas", "Mermelada de frutos rojos", "kg", "Cocina"),
    ("Salsas", "Salsa cesar", "kg", "Cocina"),
    ("Salsas", "salsa de caramelo", "kg", "Cocina"),
    ("Salsas", "salsa de vainilla", "kg", "Cocina"),
    ("Salsas", "Salsa holandesa", "kg", "Cocina"),
    ("Salsas", "Salsa toffee", "kg", "Cocina"),
    ("Salsas", "Salsa yogur y sriracha", "kg", "Cocina"),
    ("Salsas", "Sriracha", "kg", "Cocina"),
    # ── Sub-recetas ──
    ("Sub-recetas", "Aderezo cesar", "kg", "Cocina"),
    ("Sub-recetas", "Almibar", "kg", "Cocina"),
    ("Sub-recetas", "buttercream", "kg", "Cocina"),
    ("Sub-recetas", "caramel muffins", "kg", "Cocina"),
    ("Sub-recetas", "Chipa elaboracion", "u", "Cocina"),
    ("Sub-recetas", "Chipa prensado elaboracion", "u", "Cocina"),
    ("Sub-recetas", "Cookie de nuez elaboracion", "u", "Cocina"),
    ("Sub-recetas", "Cookie red velvet", "u", "Cocina"),
    ("Sub-recetas", "Crema bariloche", "kg", "Cocina"),
    ("Sub-recetas", "Crema chantilly", "kg", "Cocina"),
    ("Sub-recetas", "crema chanty de vainilla", "kg", "Cocina"),
    ("Sub-recetas", "crema de coco", "kg", "Cocina"),
    ("Sub-recetas", "crema para batir", "kg", "Cocina"),
    ("Sub-recetas", "Croutones", "kg", "Cocina"),
    ("Sub-recetas", "crumble brioche de pastelera", "kg", "Cocina"),
    ("Sub-recetas", "diplomata tartaleta", "kg", "Cocina"),
    ("Sub-recetas", "Empaste", "kg", "Cocina"),
    ("Sub-recetas", "Frangipane", "kg", "Cocina"),
    ("Sub-recetas", "Ganache pistacho", "kg", "Cocina"),
    ("Sub-recetas", "Granola elaboracion", "kg", "Cocina"),
    ("Sub-recetas", "Huevada", "kg", "Cocina"),
    ("Sub-recetas", "Jugo detox elaboracion", "lt", "Cocina"),
    ("Sub-recetas", "Masa de tarta", "u", "Cocina"),
    ("Sub-recetas", "Masa pan brioche", "kg", "Cocina"),
    ("Sub-recetas", "masa tarta dulce", "u", "Cocina"),
    ("Sub-recetas", "Masa wraps", "u", "Cocina"),
    ("Sub-recetas", "Merengue italiano", "kg", "Cocina"),
    ("Sub-recetas", "mix tucumanos", "kg", "Cocina"),
    ("Sub-recetas", "montblanc creamroll de pasteleraAgua", "lt", "Cocina"),
    ("Sub-recetas", "Pastelera", "kg", "Cocina"),
    ("Sub-recetas", "Pesto elaboracion", "kg", "Cocina"),
    ("Sub-recetas", "Tarta elaboracion", "u", "Cocina"),
    ("Sub-recetas", "Wrap elaboracion", "u", "Cocina"),
    # ── Varios ──
    ("Varios", "Anana congelada cubos", "kg", "Cocina"),
    ("Varios", "anana congelado", "kg", "Cocina"),
    ("Varios", "Bolsa de rresiduo verde", "u", "Cocina"),
    ("Varios", "Castañas de caju enteras", "kg", "Cocina"),
    ("Varios", "Castañas de caju partidas", "kg", "Cocina"),
    ("Varios", "Coco en escamas", "kg", "Cocina"),
    ("Varios", "Coco rallado", "kg", "Cocina"),
    ("Varios", "Frambuesa", "kg", "Cocina"),
    ("Varios", "Frambuesa congelada", "kg", "Cocina"),
    ("Varios", "frambuesa liofilizada", "kg", "Cocina"),
    ("Varios", "Hielo", "kg", "Cocina"),
    ("Varios", "mix de frutos rojos congelados", "kg", "Cocina"),
    ("Varios", "papas gauchitas", "kg", "Cocina"),
    ("Varios", "RADOS", "kg", "Cocina"),
    ("Varios", "recorte laminado", "kg", "Cocina"),
    ("Varios", "Semolin", "kg", "Cocina"),
    # ── Verduras ──
    ("Verduras", "Acelga", "kg", "Cocina"),
    ("Verduras", "aderezo de pepino", "kg", "Cocina"),
    ("Verduras", "Ajo", "kg", "Cocina"),
    ("Verduras", "Ajo asado", "kg", "Cocina"),
    ("Verduras", "Albahaca", "kg", "Cocina"),
    ("Verduras", "alfajor de pistacho elaboracion", "u", "Cocina"),
    ("Verduras", "Apio", "kg", "Cocina"),
    ("Verduras", "Batata", "kg", "Cocina"),
    ("Verduras", "Berenjena", "kg", "Cocina"),
    ("Verduras", "Boniato", "kg", "Cocina"),
    ("Verduras", "Brocoli", "kg", "Cocina"),
    ("Verduras", "Brotes", "kg", "Cocina"),
    ("Verduras", "Cebolla blanca", "kg", "Cocina"),
    ("Verduras", "Cebolla de verdeo", "kg", "Cocina"),
    ("Verduras", "Cebolla morada", "kg", "Cocina"),
    ("Verduras", "Choclo", "kg", "Cocina"),
    ("Verduras", "Ciboulette", "kg", "Cocina"),
    ("Verduras", "Cibulette", "kg", "Cocina"),
    ("Verduras", "Cilantro", "kg", "Cocina"),
    ("Verduras", "Coliflor", "kg", "Cocina"),
    ("Verduras", "Coriandro", "kg", "Cocina"),
    ("Verduras", "Eneldo", "kg", "Cocina"),
    ("Verduras", "Espinaca", "kg", "Cocina"),
    ("Verduras", "Espinaca congelada", "kg", "Cocina"),
    ("Verduras", "Hongos", "kg", "Cocina"),
    ("Verduras", "hongos cocidos", "kg", "Cocina"),
    ("Verduras", "Jengibre", "kg", "Cocina"),
    ("Verduras", "Jugo de jengibre elaboracion", "lt", "Cocina"),
    ("Verduras", "Jugo de pepino elaboracion", "lt", "Cocina"),
    ("Verduras", "Jugo de zanahoria elaboracion", "lt", "Cocina"),
    ("Verduras", "Jugo de zanahoria, naraja y jengibre", "lt", "Cocina"),
    ("Verduras", "Kale", "kg", "Cocina"),
    ("Verduras", "Lechuga manteca", "kg", "Cocina"),
    ("Verduras", "Lechuga morada", "kg", "Cocina"),
    ("Verduras", "Menta", "kg", "Cocina"),
    ("Verduras", "Mix de verdes", "kg", "Cocina"),
    ("Verduras", "Mix flores comestibles", "kg", "Cocina"),
    ("Verduras", "Morron rojo", "kg", "Cocina"),
    ("Verduras", "Palta", "kg", "Cocina"),
    ("Verduras", "Papa blanca", "kg", "Cocina"),
    ("Verduras", "Papines blancos", "kg", "Cocina"),
    ("Verduras", "Pasta de palta", "kg", "Cocina"),
    ("Verduras", "Pepino", "kg", "Cocina"),
    ("Verduras", "Perejil", "kg", "Cocina"),
    ("Verduras", "Pickle de pepino", "kg", "Cocina"),
    ("Verduras", "Puerro", "kg", "Cocina"),
    ("Verduras", "Pure de tomate", "kg", "Cocina"),
    ("Verduras", "queso crema con eneldo", "kg", "Cocina"),
    ("Verduras", "Rabanito", "kg", "Cocina"),
    ("Verduras", "Relleno tarta espinaca", "u", "Cocina"),
    ("Verduras", "Remolacha", "kg", "Cocina"),
    ("Verduras", "Repollo blanco", "kg", "Cocina"),
    ("Verduras", "Repollo morado", "kg", "Cocina"),
    ("Verduras", "Rucula", "kg", "Cocina"),
    ("Verduras", "Tomate cherry", "kg", "Cocina"),
    ("Verduras", "Tomate perita", "kg", "Cocina"),
    ("Verduras", "Tomate redondo", "kg", "Cocina"),
    ("Verduras", "Tomates secos", "kg", "Cocina"),
    ("Verduras", "Zanahoria", "kg", "Cocina"),
    ("Verduras", "Zanahoria baby", "kg", "Cocina"),
    ("Verduras", "Zapallo anco", "kg", "Cocina"),
    ("Verduras", "Zapallo cabutia", "kg", "Cocina"),
    ("Verduras", "Zucchini", "kg", "Cocina"),
    # ══════ BARRA ══════
    # ── Bebidas ──
    ("Bebidas", "Agua con gas 500 cc premium", "u", "Barra"),
    ("Bebidas", "agua morgsde", "u", "Barra"),
    ("Bebidas", "Agua sin gas 500 cc premium", "u", "Barra"),
    ("Bebidas", "Agua tonica", "u", "Barra"),
    ("Bebidas", "aperol", "lt", "Barra"),
    ...
    # ── Café ──
    ("Café", "ANA DONNEYS 125 G", "u", "Barra"),
    ("Café", "ANA DONNEYS 1KG - PARA FI", "lt", "Barra"),
    ("Café", "Cafe Aponte 1/4", "u", "Barra"),
    ("Café", "Cafe Augusto 1/4", "u", "Barra"),
    ("Café", "Cafe Bambuco 1/4", "u", "Barra"),
    ("Café", "Cafe Cumbia 1/4", "u", "Barra"),
    ("Café", "Cafe en granos", "kg", "Barra"),
    ("Café", "Cafe molido", "kg", "Barra"),
    ("Café", "Cafe Samba 1/4", "u", "Barra"),
    ("Café", "Cafe Trailblazer 1/4", "u", "Barra"),
    # ── Packaging ──
    ("Packaging", "Agitador de cafe bamboo", "u", "Barra"),
    ("Packaging", "Bobina Elite", "u", "Barra"),
    ("Packaging", "Bolsa de residuo negra", "u", "Barra"),
    ("Packaging", "Bolsa kraft delivery", "u", "Barra"),
    ("Packaging", "Botella 1L", "u", "Barra"),
    ("Packaging", "Botella 500ml", "u", "Barra"),
    ("Packaging", "Bowl compostable 500cc", "u", "Barra"),
    ("Packaging", "Bowl compostable 960cc", "u", "Barra"),
    ("Packaging", "Caja kraft compostable hamburguesa", "u", "Barra"),
    ("Packaging", "Caja torta 24 cm", "u", "Barra"),
    ("Packaging", "Cuchara", "u", "Barra"),
    ("Packaging", "Cuchillo", "u", "Barra"),
    ("Packaging", "Ecocuchillo 16 cm", "u", "Barra"),
    ("Packaging", "Ecotenedor 16 cm", "u", "Barra"),
    ("Packaging", "Estuche compostable mediano", "u", "Barra"),
    ("Packaging", "Frasco 220ml", "u", "Barra"),
    ("Packaging", "Frasco 300ml", "u", "Barra"),
    ("Packaging", "Lavandina x 5 Lt", "u", "Barra"),
    ("Packaging", "Molde pan dulce", "u", "Barra"),
    ("Packaging", "Papel Aluminio", "u", "Barra"),
    ("Packaging", "Papel Film", "u", "Barra"),
    ("Packaging", "pirotines para muffins", "u", "Barra"),
    ("Packaging", "Platos cafe", "u", "Barra"),
    ("Packaging", "porta vaso", "u", "Barra"),
    ("Packaging", "servilletas", "u", "Barra"),
    ("Packaging", "Sorbetes biodegradables", "u", "Barra"),
    ("Packaging", "sorbetes compostable", "u", "Barra"),
    ("Packaging", "Tapa bowl compostable 500cc", "u", "Barra"),
    ("Packaging", "Tapa bowl compostable 960cc", "u", "Barra"),
    ("Packaging", "Tapa vaso iced 12oz", "u", "Barra"),
    ("Packaging", "Tapa vaso polipapel cafe 12oz", "u", "Barra"),
    ("Packaging", "Tapa vaso polipapel cafe 8oz", "u", "Barra"),
    ("Packaging", "Tazas cafe", "u", "Barra"),
    ("Packaging", "Tenedor", "u", "Barra"),
    ("Packaging", "Vaso iced 12oz", "u", "Barra"),
    ("Packaging", "Vaso polipapel cafe 12oz", "u", "Barra"),
    ("Packaging", "Vaso polipapel cafe 8oz", "u", "Barra"),
    # ── Té e infusiones ──
    ("Té e infusiones", "earl great", "kg", "Barra"),
    ("Té e infusiones", "English breakfast", "kg", "Barra"),
    ("Té e infusiones", "Hibiscus", "kg", "Barra"),
    ("Té e infusiones", "Matcha en polvo", "kg", "Barra"),
    ("Té e infusiones", "Te dulces recuerdos", "kg", "Barra"),
    ("Té e infusiones", "Te hierbas digestivas", "kg", "Barra"),
    ("Té e infusiones", "Te Negro", "kg", "Barra"),
    ("Té e infusiones", "very berries", "kg", "Barra"),
]
